...
int main(int argc, char** argv){
    ...
    if(argc != 4){
        std::cout << "Err: ./ClusterSRCoordinator (num_repair_chunk) (fail_node_id) (repair_scheme)" << std::endl;
        exit(1);
    }
    ...
    if(strcmp(argv[3], "clustersr") == 0) 
        clustersr_cnt = coord->ClusterSR(fail_node);
